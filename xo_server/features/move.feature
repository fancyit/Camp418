...
Сценарий: Ход игрока
  ...
  Структура сценария: Ход игрока в заполненную клетку
    ...
    Сценарий: определение победителя по горизонтали
        Дано поле "102|110|202"
        И ходит игрок 1
        Если игрок ходит в клетку 2, 3
        То поле становится "102|111|202"
        И победил игрок 1
    Сценарий: определение победителя по диагонали
        Дано поле "011|121|202"
        И ходит игрок 2
        Если игрок ходит в клетку 1, 1
        То поле становится "211|121|202"
        И победил игрок 2